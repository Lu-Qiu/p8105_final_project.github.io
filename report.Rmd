...
The raw data is a global listing of over 800 volcanic eruptions and their information. We clean the data format, make sure the variables are appropriately encoded, correct or shorten some of the character variables' values, and select the variables of our interest. The final dataset used for the analysis has `18` variables, listed below:
