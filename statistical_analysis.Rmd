...
* For every one unit increase in volcanic explosivity index (VEI), the odds of causing more deaths (i.e., very many, many or some versus few) is multiplied 1.85 times (i.e., increases 81%), holding constant all other variables.
