...
`volcano_deaths_description` is a four-level variable, with levels "Few (~1 to 50)", "Some (~51 to 100)", "Many (~101 to 1000)", "Very Many (~1001 or more)", coded 1, 2, 3, and 4  respectively, that we will use as our outcome variable. 
