...
## The Factors Influencing Volcanic Losses(numeric)
...
### Plot: Tsunami Occurrence Influencing Volcanic Losses
...
tsunami_damage = 
  ...
  geom_boxplot() +
  labs(title = "Damage(money in million) vs Tsunami", x = "Tsunami Occurrence", y = "ln_Damage(money in million)") 
...
* Comment: The box plots above indicate a noticeable influence of tsunami occurrence on the volcanic losses. The tsunami effects triggered by volcanic activities are likely to contribute to an increase in both casualties and property damage.

### Plot: Earthquake Occurrence Influencing Volcanic Losses
...
earthquake_damage = 
  ...
  geom_boxplot() +
  labs(title = "Damage(money in million) VS Earthquake", x = "Earthquake Occurrence", y = "ln_Damage(money in million)") 
...
* Comment: The above box plots indicate that when volcanic eruptions trigger volcanic earthquakes, there is a generally noticeable increase in casualties and property damage compared to situations where volcanic earthquakes are not triggered.

### Plot: Volcano Type Influencing Volcanic Losses
...
type_damage =
  ...
  geom_boxplot() +
  labs(title = "Damage vs Volcano Type", x = "Volcano Type", y = "ln_Damage(money in million)")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.position = "none")
...
### Plot: VEI Influencing Volcanic Losses
...
VEI_damage =
  ...
  geom_boxplot() +
  labs(title = "Damage(money in million) vs VEI", x = "VEI (level)", y = "ln_Damage(money in million)") +
  theme(legend.position = "none")
...
* Comment: The above box plots show that with the increase in the volcanic explosivity index, there is a general upward trend in casualties and property damage caused by volcanic eruptions. In other words, as the energy of the volcanic eruption increases, the casualties and losses become more severe.
