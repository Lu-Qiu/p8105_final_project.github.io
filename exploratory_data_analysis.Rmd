...
ggplot(iceland_volcanic_data, aes(x = year, fill = as.factor(-year))) +
  ...
  theme_minimal() +
  theme(legend.position = "none") + 
  labs(title = "Plot 1: Distribution of Volcanic Eruptions in Iceland Over Time",
       x = "Year",
       y = "Number of Eruptions")
...
iceland_volcanic_data %>%
  ...
  scale_fill_viridis_d()+
  theme_minimal() +
  labs(title = "Plot 2: Prevalence of Different Volcano Types in Iceland",
       x = "Volcano Type",
       y = "Count") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```

Plot 2 indicates that stratovolcanoes are the most prevalent volcano type in Iceland, suggesting varied and complex volcanic activity.
...
iceland_volcanic_data |>
  ...
  theme_minimal() +
  labs(title = "Plot 3: Distribution of Volcanic Explosivity Index (VEI) in Iceland",
       x = "VEI",
       y = "Count")

```

Plot 3 shows that eruptions with a Volcanic Explosivity Index of 3 and 4 are most common in Iceland, indicating moderate explosivity is typical for Icelandic eruptions.